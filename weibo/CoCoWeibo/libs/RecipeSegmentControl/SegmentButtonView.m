...
@property(nonatomic, strong) id <SegmentButtonViewDelegate> delegate;
...
- (SegmentButtonView *)initWithTitle:(NSString *)title
    ...
    if (self) {
        ...
        self.textColor = [UIColor colorWithRed:20.0 / 255.0 green:20.0 / 255.0 blue:50.0 / 255.0 alpha:1.0];
        self.shadowColor = [UIColor colorWithRed:170.0 / 255.0 green:170.0 / 255.0 blue:170.0 / 255.0 alpha:1.0];
...
//        self.normalImage.size.width, self.normalImage.size.height);
        self.imageView.frame = CGRectMake(0,-TOP_OFFSET, 160,self.normalImage.size.height);
