...
{
    [httpManager postTencentWithText:text];
}

//发布文字图片微博 -- 腾讯
-(void)postTencentWithText:(NSString *)text image:(UIImage *)image
{
    [httpManager postTencentWithText:text image:image];
}
...
{
    [httpManager getTencentHomeLine:format pageflag:pageflag pagetime:pagetime reqnum:reqnum type:type contenttype:contenttype oauth_consumer_key:oauth_consumer_key access_token:access_token openid:openid clientip:clientip oauth_version:oauth_version scope:scope];
